          ...
          <tr>
            <td style="background:white;padding:36px 40px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;margin-bottom:24px;">
                ...
                <tr><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#64748b;font-size:13px;width:38%;">🚌 Bus Name</td><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#1e293b;font-size:13px;font-weight:500;">${busName}</td></tr>
                <tr><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#64748b;font-size:13px;">🏷️ Bus Type</td><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#1e293b;font-size:13px;font-weight:500;">${busType}</td></tr>
                <tr><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#64748b;font-size:13px;">📅 Travel Date</td><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#1e293b;font-size:13px;font-weight:500;">${depDate}</td></tr>
                <tr><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#64748b;font-size:13px;">🕐 Departure</td><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#1e293b;font-size:13px;font-weight:500;">${depTime}</td></tr>
                <tr><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#64748b;font-size:13px;">🕐 Arrival</td><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#1e293b;font-size:13px;font-weight:500;">${arrTime}</td></tr>
                <tr><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#64748b;font-size:13px;">💺 Seat(s)</td><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;font-size:13px;font-weight:500;"><strong style="color:#667eea">${seats}</strong> (${seatCount} seat${seatCount > 1 ? 's' : ''})</td></tr>
                <tr><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#64748b;font-size:13px;">💰 Amount Paid</td><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;font-size:13px;"><strong style="color:#10b981;font-size:16px">${fmtCurrency(booking.totalAmount)}</strong></td></tr>
                <tr><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#64748b;font-size:13px;">📱 Phone</td><td style="padding:12px 20px;border-bottom:1px solid #f1f5f9;color:#1e293b;font-size:13px;font-weight:500;">${booking.phone}</td></tr>
                <tr><td style="padding:12px 20px;color:#64748b;font-size:13px;">✉️ Email</td><td style="padding:12px 20px;color:#1e293b;font-size:13px;font-weight:500;">${booking.email}</td></tr>
              </table>
